module JwtAuthenticator
  ...
  def encode(user_id)
    ...
    JWT.encode(preload, Rails.application.credentials.secret_key_base, 'HS256')
  end

  # 復号化処理
  def decode(encoded_token)
    decoded_dwt = JWT.decode(encoded_token, Rails.application.credentials.secret_key_base, true, algorithm: 'HS256')
    decoded_dwt.first
  end
